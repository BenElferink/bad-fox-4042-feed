      ...
      <div className='animate__animated animate__fadeIn'>
        <section
          className={
            ...
            ' relative flex flex-col items-center md:min-w-[420px] max-w-screen md:max-w-[90vw] w-screen md:w-fit min-h-screen md:min-h-fit max-h-screen md:max-h-[90vh] p-4 md:rounded-3xl  ' +
            className
          }
          style={style}
        >
